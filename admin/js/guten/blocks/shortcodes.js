...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _includes_blocks_visitor_votes_block_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../includes/blocks/visitor-votes/block.json */ \"./includes/blocks/visitor-votes/block.json\");\n/* harmony import */ var _registerBlockTypeEdit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../registerBlockTypeEdit */ \"./admin/js/src/guten/registerBlockTypeEdit.js\");\n/* harmony import */ var _registerBlockTypeSave__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../registerBlockTypeSave */ \"./admin/js/src/guten/registerBlockTypeSave.js\");\nvar registerBlockType = wp.blocks.registerBlockType; // Import from wp.blocks\n\n\n\n\n/**\n * Register: a Gutenberg Block.\n *\n * Registers a new block provided a unique name and an object defining its\n * behavior. Once registered, the block is made editor as an option to any\n * editor interface where blocks are implemented.\n *\n * @link https://wordpress.org/gutenberg/handbook/block-api/\n * @param  {string}   name     Block name.\n * @param  {Object}   settings Block settings.\n * @return {?WPBlock}          The block, if it has been successfully\n *                             registered; otherwise `undefined`.\n */\n\nregisterBlockType(_includes_blocks_visitor_votes_block_json__WEBPACK_IMPORTED_MODULE_0__, {\n  edit: _registerBlockTypeEdit__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  save: function save(props) {\n    return (0,_registerBlockTypeSave__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(props, _includes_blocks_visitor_votes_block_json__WEBPACK_IMPORTED_MODULE_0__);\n  }\n});\n\n//# sourceURL=webpack://yet-another-stars-rating/./admin/js/src/guten/blocks/visitorVotes.js?");
