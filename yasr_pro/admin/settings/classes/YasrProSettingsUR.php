 ...
 * @return
 */
class YasrProSettingsUR {
    public function init () {
        add_action('admin_init', array($this, 'urOptionsInit'));
    }
     ...
     * @return mixed
     */
    function customizeStringDescription($yasr_settings_descriptions) {
