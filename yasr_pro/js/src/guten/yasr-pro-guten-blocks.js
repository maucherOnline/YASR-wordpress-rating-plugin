...
const yasrProLabelSelectRows = __('How many rows do you want to display?', 'yet-another-stars-rating');
const yasrProLabelSelectText = __('Show text before or after the stars?', 'yet-another-stars-rating');
const yasrProLabelCptText = __('Do you want to specify a custom post type? ', 'yet-another-stars-rating');
