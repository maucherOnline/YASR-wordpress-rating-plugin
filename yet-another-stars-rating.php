...
if ( ! function_exists( 'yasr_fs' ) ) {
    ...
    define('YASR_VERSION_NUM', '3.3.6.1');
    ...
    function yasr_plugin_row_meta($links, $file) {
        ...
        if (yasr_fs()->is_free_plan()) {
            // create link
            if ($file === $plugin) {
                $links[] = '<a href="https://yetanotherstarsrating.com/?utm_source=wp-plugin&utm_medium=above_description&utm_campaign=yasr_plugin_list">'
                               . __( 'Buy Yasr Pro', 'yet-another-stars-rating' ) .
                            '</a>';
            }
